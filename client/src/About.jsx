  ...
  return (
    <div className="about-me">
      ...
      <p className="additional-info">
        Apart from coding, I am passionate about user interfaces, responsive design, and creating
        engaging user experiences. Let's turn ideas into reality through clean and elegant code!
      </p>
    </div>
  );
};
